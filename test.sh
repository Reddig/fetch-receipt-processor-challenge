json=$(curl -X POST -H "Content-Type: application/json" -d '{"retailer": "CVS123456", "purchaseDate": "2020-01-01", "purchaseTime": "15:59", "items": [{"id": "1", "shortDescription": "an item1", "price": "10000000.00"},{"id": "2", "shortDescription": "   123456     ", "price": "101.00"},{"id": "3", "shortDescription": "123456   ", "price": "100.00"}], "total": "10000201.00"}' http://localhost:8080/receipts/process)
echo $json
